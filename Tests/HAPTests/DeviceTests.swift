...
class DeviceTests: XCTestCase {
    func testInstanceIdentifiers() {
        ...
        do {
            let lamp = Accessory.Lightbulb(info: .init(name: "Night stand left", serialNumber: "00041"), type: .color, isDimmable: true)
        ...
        do {
            let lamp = Accessory.Lightbulb(info: .init(name: "Night stand left", serialNumber: "00042"), type: .color, isDimmable: true)
            let device = Device(setupCode: "123-44-321", storage: MemoryStorage(), accessory: lamp)
            let accessories = device.accessories
            let services = accessories.flatMap({ $0.services })
            let characteristics = services.flatMap({ $0.characteristics })
        ...
        do {
            ...
            let lamp = Accessory.Lightbulb(info: .init(name: "Night stand left", serialNumber: "00044"), type: .color, isDimmable: true)
