...
class CryptographerTests: XCTestCase {
    ...
    func testReadSimpleFrame() {
        ...
        encryptedBuffer.writeBytes(Data(hex: "0d0086707542af59d8a62123455257e9f45b349501f46cad0e5f6ded6aab98")!)
        XCTAssertNoThrow(try channel.writeInbound(encryptedBuffer))

        var plaintextBuffer = channel.allocator.buffer(capacity: 13)
        plaintextBuffer.writeString("Hello, world!")
    ...
    func testReadMultipleFramesSingleRead() {
        ...
        encryptedBuffer.writeBytes(Data(hex: "0d0086707542af59d8a62123455257e9f45b349501f46cad0e5f6ded6aab98")!)
        encryptedBuffer.writeBytes(Data(hex: "0d008b0d47a5c7e28b261015018c275ea42388d7284df1bb0737bcc7b5b5f5")!)
        encryptedBuffer.writeBytes(Data(hex: "0d0008557d6198431e6121f10b8f9739009732201c917d67c9b05355bcb733")!)
        XCTAssertNoThrow(try channel.writeInbound(encryptedBuffer))
    ...
    func testReadPartialFramesMultipleReads() {
        ...
        encryptedBufferFirst.writeBytes(Data(hex: "0d00")!)
        XCTAssertNoThrow(try channel.writeInbound(encryptedBufferFirst))

        XCTAssertEqual(readRecorder.reads, [])

        var encryptedBufferLast = channel.allocator.buffer(capacity: 30)
        encryptedBufferLast.writeBytes(Data(hex: "86707542af59d8a62123455257e9f45b349501f46cad0e5f6ded6aab98")!)
        XCTAssertNoThrow(try channel.writeInbound(encryptedBufferLast))
    ...
    func testWriteSingleFrame() {
        var plaintextBuffer = channel.allocator.buffer(capacity: 13)
        plaintextBuffer.writeString("Hello, world!")
        XCTAssertNoThrow(try channel.writeOutbound(plaintextBuffer))

        var expectedBuffer = channel.allocator.buffer(capacity: 31)
        expectedBuffer.writeBytes(Data(hex: "0d0027359e45fd3856d016b501c8558b915d704849af57525276a9f91b789b")!)
    ...
    func testWriteMultipleFrames() {
        ...
        buffer.writeBytes(Data(repeating: 0, count: 1536))
        XCTAssertNoThrow(try channel.writeOutbound(buffer))

        var frame0 = channel.allocator.buffer(capacity: 1572)
        frame0.writeBytes(Data(hex: "")!)
